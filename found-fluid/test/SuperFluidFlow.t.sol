...
contract SuperFluidFlowTest is Test {
    ...
    uint256 public constant INITIAL_BALANCE = 10000000 * 1e18;
    ...
    function testInitializeFlow() public {
        ...
        IFluidFlowStorage fundStorage = IFluidFlowStorage(storageFactory.createStorage(address(flowContract), block.timestamp + FUND_DURATION));
